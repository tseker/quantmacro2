function [k1,prodn1] = aiyagari8_1(r0,w0,lambda0)
...
global beta mu s b N prob kk kap v dist n_pol c_pol tau
...
while test > 0.01
        % Policy functions and expected value
            [c_pol, n_pol, kk, tv, indU] = golden8_1(prodwage_gd,rkap_gd,cmin_gd,cmax_gd,prob_gd*v,lambda0);
        % Recover matrix form
