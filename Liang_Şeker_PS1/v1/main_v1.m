...
global beta mu A delta alpha s b N prob kk kap nkap v dist maxkap minkap inckap % This line declares certain variables as global, indicating that they are defined outside the scope of this function. It's assumed that these variables are defined elsewhere in your script or program.
...
for j=1:N
        for i=1:nkap              
            cons(j,i) = s(j)*wage + (1+r0)*kap(i) -kopt(j,i);  % kap: state of the assets  kap=minkap:inckap:maxkap
        end
end
