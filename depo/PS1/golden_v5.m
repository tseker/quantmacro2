...
% UPDATED to extract aditional output

function [x1,f1,other] = golden(f,a,b,varargin)
...
x1 = a+alpha1*d;
x2 = a+alpha2*d;
[f1,other] = feval(f,x1,varargin{:});
[f2,other2] = feval(f,x2,varargin{:});
...
while d>tol
  ...
  if f2<f1 % x2 is new upper bound
    x2 = x1; x1 = x1-d; 
    f2 = f1; [f1,other] = feval(f,x1,varargin{:});
  else     % x1 is new lower bound
    x1 = x2; x2 = x2+d; 
    f1 = f2; [f2,other2] = feval(f,x2,varargin{:});
  end
end

% Return the larger of the two
if f2>f1, x1 = x2; f1 = f2; other = other2; end
