...
rng(12345) % fix seed, random shocks will be the same, speed of convergence doesn't come from different samples
...
err_sim=1;
while err_sim>1e-4 %how many periods we converge to..
    ...
    asim = asim_prime; % update savings for use at t+1 (asset supply today=asset supply tomorrow)
